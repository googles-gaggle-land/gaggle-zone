...
public sealed class PaintingSystem : SharedPaintingSystem
{
    ...
    {
        if (!_solutionContainerSystem.TryGetSolution(uid, PaintAbsorbentComponent.SolutionName, out _, out var solution))
            return;
    ...
    public void Mop(EntityUid user, EntityUid target, EntityUid used, PaintAbsorbentComponent component)
    {
        if (!_solutionContainerSystem.TryGetSolution(used, PaintAbsorbentComponent.SolutionName, out var absorberSoln))
            return;
    ...
    /// </summary>
    private bool TryRefillableInteract(EntityUid user, EntityUid used, EntityUid target, PaintAbsorbentComponent component, UseDelayComponent? useDelay, Entity<SolutionComponent> absorbentSoln)
    {
    ...
    private bool TryTransferFromAbsorbentToRefillable(
        ...
        EntityUid used,
        EntityUid target,
        PaintAbsorbentComponent component,
        ...
        Entity<SolutionComponent> refillableSoln)
    {
        ...
        var contaminants = _solutionContainerSystem.SplitSolutionWithout(absorbentSoln, transferAmount, PaintReagents);
    ...
    private bool TryTwoWayAbsorbentRefillableTransfer(
        ...
        Entity<SolutionComponent> refillableSoln)
    {
        var contaminantsFromAbsorbent = _solutionContainerSystem.SplitSolutionWithout(absorbentSoln, component.PickupAmount, PaintReagents);
        ...
        var refillableSolution = refillableSoln.Comp.Solution;
        var waterFromRefillable = refillableSolution.SplitSolutionWithOnly(waterPulled, PaintReagents);
    ...
    /// </summary>
    private bool TryPuddleInteract(EntityUid user, EntityUid used, EntityUid target, PaintAbsorbentComponent absorber, UseDelayComponent? useDelay, Entity<SolutionComponent> absorberSoln)
    {
        ...
        var available = absorberSolution.GetTotalPrototypeQuantity(PaintReagents);
        ...
        var puddleSplit = puddleSolution.SplitSolutionWithout(transferAmount, PaintReagents);
        var absorberSplit = absorberSolution.SplitSolutionWithOnly(puddleSplit.Volume, PaintReagents);
