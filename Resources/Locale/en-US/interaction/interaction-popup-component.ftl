...
petting-success-cookie = You pet {THE($target)} on {POSS-ADJ($target)} exoskeleton-reinforced head.
...
petting-failure-cookie = You reach out to pet {THE($target)}, but are met with hisses!
